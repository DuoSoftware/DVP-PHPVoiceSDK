...
class Speak
{
  ...
  function GetResult()
  {
    ...
    {       
        ...
        return $jsonStart.$jsonAction.$jsonFile.$jsonNextUrl.$jsonResult.$jsonErrorFile.$jsonDigitTimeOut.$jsonInputTimeOut.$jsonLoops.$jsonEngine.$jsonVoice.$jsonTerminator.$jsonStrip.$jsonDigits.$jsonEnd;
    }
    catch(exception $ex)
    {
        return $ex;
