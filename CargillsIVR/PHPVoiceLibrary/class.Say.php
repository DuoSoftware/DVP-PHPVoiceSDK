...
class Say
{
  ...
  function GetResult()
  {
    try
    {
        ...
        return $jsonStart.$jsonAction.$jsonFile.$jsonNextUrl.$jsonResult.$jsonErrorFile.$jsonDigitTimeOut.$jsonInputTimeOut.$jsonLoops.$jsonLanguage.$jsonType.$jsonMethod.$jsonGender.$jsonTerminator.$jsonStrip.$jsonDigits.$jsonEnd;
    }
    catch(exception $ex)
    {
        return $ex;
